...
public class NGTriangle1 extends NGFigureWithHalo
{
  
  private static final float MYSTERIOUS_FACTOR = 0.53f;

  public NGTriangle1(float strokeWeight, Color fillColor, Color strokeColor, Color textColor,
      float width, int haloWidth)
  {
    super(strokeWeight, fillColor, strokeColor, textColor, width, haloWidth);
  }
  
  public NGTriangle1(float strokeWeight, Color fillColor, Color strokeColor)
  {
    super(strokeWeight, fillColor, strokeColor, JGVConstants.TEXT_COLOR);
  }

  public NGTriangle1(Color fillColor)
  {
    super(fillColor);
  }
  ...
  protected boolean isMouseOver()
  {
    ...
    Vec2D a = new Vec2D(_xCoord - haloWidth, _yCoord + haloWidth * MYSTERIOUS_FACTOR);
    Vec2D b = new Vec2D(_xCoord, _yCoord - haloWidth);
    Vec2D c = new Vec2D(_xCoord + haloWidth, _yCoord + haloWidth * MYSTERIOUS_FACTOR);
